            ...
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="规模">
                  <a-input placeholder="请输入" v-model:value="modal.form.guimo"></a-input>
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="行业">
                  <a-input placeholder="请输入" v-model:value="modal.form.hangye"></a-input>
                </a-form-item>
              </a-col>
            </a-row>
          </a-form>
...
import { createApi, listApi, updateApi, deleteApi } from '/@/api/admin/company';
    ...
    keyword: data.keyword,
      ...
      .then((res) => {
        ...
        res.data.forEach((item: any, index: any) => {
          item.index = index + 1;
          item.coverUrl = BASE_URL +  item.cover
        });
  ...
  myform.value
      ...
      .then(() => {
        ...
        if (modal.form.location) {
          ...
          formData.append('guimo', modal.form.guimo)
        } if (modal.form.hangye) {
          formData.append('hangye', modal.form.hangye)
        }
        if (modal.editFlag) {
          updateApi({
            id: modal.form.id
