...
class Thing(models.Model):
    ...
    phone = models.CharField(max_length=20, blank=True, null=True) #增加联系电话
    work_date = models.CharField(max_length=50, blank=True, null=True) #增加工作日期
    work_hours = models.CharField(max_length=50, blank=True, null=True) #增加工作时长
